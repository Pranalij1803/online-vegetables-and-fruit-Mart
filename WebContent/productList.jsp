...
<body>
    ...
    <div class="container">
      <a class="navbar-brand" href="adminHome.jsp">Veggie And Fruits</a>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12">
          ...
          <p class="lead mb-5 text-white-50">Fresh Fruits And Vegetables</p>
        </div>
      </div>
    </div>
  </header>
  ...
  <a href="adminHome.jsp" ><button  type="submit" class="btn bg-light ">Back</button></a>
    ...
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; VeggieAndFruitsgmail.com 2020</p>
    </div>
    <!-- /.container -->
  </footer>
</body>
